# Generated by Django 5.0.4 on 2024-09-05 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_status', models.CharField(choices=[('Process', 'Processed'), ('shipped', 'Shipped'), ('Delivered', 'Delivered')], default='Processing', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=9999)),
                ('total', models.DecimalField(decimal_places=2, default='1.99', max_digits=9999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('product_id', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=10, max_length=30, prefix='', unique=True)),
                ('title', models.CharField(max_length=100)),
                ('image', models.ImageField(upload_to='product')),
                ('description', models.TextField(blank=True, default='this is the product', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='1.99', max_digits=9999)),
                ('old_price', models.DecimalField(decimal_places=2, default='2.99', max_digits=9999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Trendify', max_length=50)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='I am an Excellent vendor', null=True)),
